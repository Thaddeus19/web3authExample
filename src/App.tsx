...
const clientId = "BGkGOsG7pfHvjrOCW0Z45l_AD320sx4Wiq0v-NCTFEeBXEri6wAHX9NlFkEBe91VYlNm4nGOgicxBSD_wjUq1OU" // get from https://dashboard.web3auth.io
...
const web3auth = new Web3Auth({
  ...
  chainConfig: {
    ...
    chainId: "0x89",
    rpcTarget: "https://rpc-mainnet.matic.quiknode.pro", // This is the public RPC we have added, please pass on your own endpoint while creating an app
  },
  uiConfig: {
    mode: "dark",
    loginMethodsOrder: ["github", "google"],
    defaultLanguage: "en",
    logoLight: "https://web3auth.io/images/w3a-L-Favicon-1.svg", // Your App Logo Here
  },
});
...
function App() {
  ...
  const switchChain = async () => {
    ...
    await web3auth?.switchChain({ chainId: "0x13881" });
